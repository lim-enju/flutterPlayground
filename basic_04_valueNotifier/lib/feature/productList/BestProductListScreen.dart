import 'package:basic_04_valueNotifier/data/ApiService.dart';
import 'package:basic_04_valueNotifier/data/Product.dart';
import 'package:basic_04_valueNotifier/feature/productList/BestProductListModel.dart';
import 'package:basic_04_valueNotifier/feature/productList/widget/ProductWidget.dart';
    ...
    return ListenableBuilder(
        ...
        builder: (BuildContext context, Widget? child) {
          return ListView.separated(
            itemCount: bestProductListModel.value.productItems.length,
            itemBuilder: (context, index) => ProductWidget(
              product: bestProductListModel.value.productItems[index],
              rank: index + 1,
            ),
